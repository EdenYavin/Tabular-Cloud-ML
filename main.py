...
def main():
    ...
    parser.add_argument("--experiment-use-preds", type=bool, default=False, help="Use the cloud as features or not")
    parser.add_argument("--encoder-rotating-key", default=False, help="Use triangulation samples or not")
