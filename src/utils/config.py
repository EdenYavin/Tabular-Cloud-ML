...
class Config(BaseModel):
    ...
    experiment_config: ExperimentConfig = ExperimentConfig(name="w_emb_w_label_w_pred", n_noise_samples=2)
    ...
    dataset_config: DatasetConfig = DatasetConfig(one_hot=True, name=DATASETS.STUDENTS_DROPOUT, split_ratio=0.5)
